...
if 'omp' in LAMMPS_TEST_MODES:
    ...
    SkipTest(GranregionTestCase, "test_granregion_funnel_parallel_omp", "wall/gran/* not accelerated by USER-OMP")
    SkipTest(GranregionTestCase, "test_granregion_mixer_parallel_omp", "wall/gran/* not accelerated by USER-OMP")
