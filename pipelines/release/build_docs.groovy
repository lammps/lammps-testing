...
node('atlas2') {
    ...
    try {
        ...
        stage('Publish') {
            ...
            sshPublisher(publishers: [sshPublisherDesc(configName: 'www1.lammps.org', transfers: [sshTransfer(cleanRemote: false, excludes: '', execCommand: 'rm -rf /var/www/lammps/docs/unstable/*', execTimeout: 120000, flatten: false, makeEmptyDirs: false, noDefaultExcludes: false, patternSeparator: '[, ]+', remoteDirectory: '', remoteDirectorySDF: false, removePrefix: '', sourceFiles: ''), sshTransfer(cleanRemote: false, excludes: '', execCommand: 'tar xvzf /var/www/lammps/docs/unstable/lammps-docs.tar.gz -C /var/www/lammps/docs/unstable && rm /var/www/lammps/docs/unstable/lammps-docs.tar.gz', execTimeout: 120000, flatten: false, makeEmptyDirs: false, noDefaultExcludes: false, patternSeparator: '[, ]+', remoteDirectory: 'lammps/docs/unstable', remoteDirectorySDF: false, removePrefix: 'lammps/doc/', sourceFiles: 'lammps/doc/lammps-docs.tar.gz')], usePromotionTimestamp: false, useWorkspaceInPromotion: false, verbose: false)])
            sshPublisher(publishers: [sshPublisherDesc(configName: 'www1.lammps.org', transfers: [sshTransfer(cleanRemote: false, excludes: '', execCommand: '', execTimeout: 120000, flatten: false, makeEmptyDirs: false, noDefaultExcludes: false, patternSeparator: '[, ]+', remoteDirectory: 'lammps/docs/unstable', remoteDirectorySDF: false, removePrefix: 'lammps/doc/', sourceFiles: 'lammps/doc/Manual.pdf')], usePromotionTimestamp: false, useWorkspaceInPromotion: false, verbose: false)])
        }
    } catch (caughtErr) {
        err = caughtErr
