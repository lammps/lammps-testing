node {
    def build_name = 'jenkins/regression-pr'

    stage 'Checkout'
    checkout([$class: 'GitSCM', branches: [[name: 'origin/pull/${GITHUB_PR_NUMBER}/merge']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[credentialsId: 'lammps-jenkins', name: 'origin', refspec: '+refs/pull/${GITHUB_PR_NUMBER}/merge:refs/remotes/origin/pull/${GITHUB_PR_NUMBER}/merge', url: 'https://github.com/lammps/lammps.git']]])
